...
function ActionButton(props: TActionButtonProps) {
    ...
    return (<button
        ...
        className={`text-white bg-gradient-to-r ${variation} hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800  dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 flex gap-2 align-middle justify-center`}
    >
        {props.icon}
        {props.label}
